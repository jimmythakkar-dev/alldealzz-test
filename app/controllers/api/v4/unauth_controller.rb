class Api::V4::UnauthController < Api::V4::BaseController
  def faq
...
Sorry. This is not possible. Once you have purchased a deal, you will need to go to the particular venue to avail the service or product. If the service or product is not available, you have the right to ask the merchant to settle the amount for another product or service pertaining to the terms and conditions of the merchant. You cannot ask for direct cash payment as refund.
  ...
  def about_us
    render_success(text: '<p>All Dealzz (AppNxt Ideas Pvt Ltd) is a mobile application that helps you to save money by offering amazing deals from nearby restaurants, cafes, spa, salon, gym, medical, grocery, apparel and much more! With over 21+ categories and 180 sub-categories, All Dealzz literally offers deals in all the categories in a city.</p>
...
<p>All Dealzz is currently available in Ahmedabad and Gandhinagar only.</p>
<p><strong>INTELLECTUAL PROPERTY</strong></p>
<p>All the intellectual property used in developing, maintaining and marketing the All Dealzz platform is solely under AppNxt Ideas Pvt Ltd only.&nbsp;</p>
...
<p>We can always be reached at <a href="mailto:support@alldealzz.com">support@alldealzz.com</a> and through phone or Whatsapp on +91-8140645678 . If you still have any more queries, then please drop us a mail on our registered office address at:</p>
<p>D-1002, Titanium City Centre,</p>
<p>Anandnagar Road, Ahmedabad &ndash; 380015</p>
<p>Gujarat</p>
