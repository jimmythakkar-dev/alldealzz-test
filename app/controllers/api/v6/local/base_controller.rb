class Api::V6::Local::BaseController < Api::V6::BaseController
  ...
  def api_detail_result(api_detail, option = {})
      ...
      has_cashback = params[:country_id].present? ? Country.find_by(id: params[:country_id]).try(:has_cashback) : true
