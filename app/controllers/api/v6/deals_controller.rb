class Api::V6::DealsController < Api::V6::BaseController
  ...
  def use
    ...
    render_success if self_redeemed_deal.present? && self_redeemed_deal.update_attributes(used_status: true, self_redeemed_at: Time.zone.now)
